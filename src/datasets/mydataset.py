...
class MyDataset(Dataset):
    def __init__(self, root_path='../data', class_name='bottle', is_train=True,
        ...
        self.mvtec_folder_path = os.path.join(
            # root_path, 'mvtec_anomaly_detection')
            root_path, 'mydata')
    ...
    def load_dataset_folder(self):
        ...
        # gt_dir = os.path.join(self.mvtec_folder_path,
        #                       self.class_name, 'ground_truth')
